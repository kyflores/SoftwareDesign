...
def make_grid():
    ...
    do_four_times(print_bar_line)
    print_plus_line()
    #alternatively put the two repeating statements into a function and call
    #that function with do_thrice
make_grid()
